...
import { Sorter } from '../../core/utils/sorter';
import { FilterTextboxComponent } from '../../core/components/filterTextbox.component';
...
@Component({ 
  ...
  templateUrl: 'app/customers/components/customers.component.html',
